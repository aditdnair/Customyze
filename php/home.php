...
<body class="container-fluid">
    ...
    <nav class="navbar nav-bar row">
        ...
        <div class="collapse navbar-collapse links" id="my-nav">
            <ul class="mr-auto phone-menu">
                <li><a href="../html/login.php" class="nav-links">Login</a></li>
                <li><a href="../html/get-started.php" class="nav-links">Get Started</a></li>
                <li><a href="../html/contacts.php" class="nav-links">About Us</a></li>
            </ul>
        </div>
    ...
    <div class="row text-center mx-auto py-5">
        <a href="../html/login.php" class="devices m-4 col"><img class="h-75" src="../svg/pc.svg"></a>
        <a href="../html/login.php" class="devices m-4 col ml-md-3"><img class="h-75" src="../svg/laptop.svg"></a>
        <a href="../html/login.php" class="devices m-4 col"><img class="h-75" src="../svg/phone.svg"></a>
    </div>
